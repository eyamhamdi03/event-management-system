...
export interface LoginResponse {
  access_token: string;       // Le token JWT d’accès
  refresh_token: string;      // Le token de refresh
  // si tu veux aussi envoyer user et accounts, il faut modifier ton backend pour les renvoyer
  user?: User;                // Optionnel, à ajouter si backend le renvoie
  accounts?: Account[];       // Optionnel, idem
}
