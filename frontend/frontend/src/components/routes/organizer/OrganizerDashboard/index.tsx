...
const OrganizerDashboard = () => {
    ...
    // Modified to include organizerId in filters
    const {data: eventsData, isFetched: isEventsFetched} = useGetEvents(
        {
            ...getEventQueryFilters(searchParams),
            hostId: organizerId  // Add organizerId as hostId filter
        } as QueryFilters
    );
     ...
     * All JSX, styling, and layout is preserved.
     */
    return (
        <>
