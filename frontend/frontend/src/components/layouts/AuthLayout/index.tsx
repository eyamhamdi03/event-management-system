...
console.log("meeeee",me.data)
       if (user?.role && user.role.toLowerCase() === Role.Organizer) {

            return <Navigate to={`/manage/organizer/${user?.id}/events`} replace />;
        }

        // Autres rôles : rediriger vers un autre chemin si besoin
